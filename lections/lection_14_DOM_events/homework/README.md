...
1) Есть вертикальное меню. При клике на элемент меню - открывается сответтствующе горизонтальное подменю. Закрывается подменю только кнопкой Close внутри подменю.